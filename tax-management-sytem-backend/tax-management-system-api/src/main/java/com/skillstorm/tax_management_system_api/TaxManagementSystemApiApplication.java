package com.skillstorm.tax_management_system_api;
...
public class TaxManagementSystemApiApplication {

	public static void main(String[] args) {
		SpringApplication.run(TaxManagementSystemApiApplication.class, args);
	}
